...
output "availability_zones" {
  value       = [aws_subnet.private_subnet_a.availability_zone, aws_subnet.private_subnet_b.availability_zone, aws_subnet.private_subnet_c.availability_zone]
  description = "Availability zones the subnets span, in a/b/c order"
}
