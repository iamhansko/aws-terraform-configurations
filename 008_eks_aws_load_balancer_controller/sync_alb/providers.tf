...
# update-kubeconfig", so the AWS Load Balancer Controller and the demo workload
# are installed without a kubeconfig file or a shell session on an EC2 instance
# (rules.md E-1).
#
