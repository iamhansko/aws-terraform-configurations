# Generated from 009_eks_ebs_csi_driver/ebs_volume_storageclass.yaml by tools/cfn2tf.
...
variable "stack_name" {
  type        = string
  default     = "ebs-volume-storageclass"
...
- matchLabelExpressions:
  - key: topology.kubernetes.io/zone
    values:
    - ${data.aws_region.current.region}a' > /home/ec2-user/manifests/storageclass.yaml
...
EOT
  ...
  depends_on                  = [aws_eks_addon.ebs_csi_driver_addon]
}
