# Generated from 000_deprecated/eks/internal/computing/fargate/internet_facing/nlb_service.yaml by tools/cfn2tf.
...
kubectl patch svc kube-ops-view -p '{"metadata": {"annotations": {"service.beta.kubernetes.io/aws-load-balancer-nlb-target-type": "ip", "service.beta.kubernetes.io/aws-load-balancer-scheme":"internet-facing", "service.beta.kubernetes.io/aws-load-balancer-manage-backend-security-group-rules":"true", "service.beta.kubernetes.io/aws-load-balancer-security-groups":"${aws_security_group.nlb_service_security_group.id}"}}, "spec": {"type": "LoadBalancer", "loadBalancerClass": "service.k8s.aws/nlb"}}'
...
EOT
  ...
  depends_on                  = [aws_eks_cluster.eks_cluster, aws_eks_fargate_profile.default_fargate_profile, aws_eks_fargate_profile.kubesystem_fargate_profile]
}
