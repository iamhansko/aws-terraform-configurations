# Generated from 000_deprecated/eks/internal/computing/automode/internet_facing/nlb_service.yaml by tools/cfn2tf.
...
resource "aws_iam_role_policy_attachment" "eks_auto_cluster_role_0" {
  role       = aws_iam_role.eks_auto_cluster_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
}
resource "aws_iam_role_policy_attachment" "eks_auto_cluster_role_1" {
  role       = aws_iam_role.eks_auto_cluster_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSComputePolicy"
}
resource "aws_iam_role_policy_attachment" "eks_auto_cluster_role_2" {
  role       = aws_iam_role.eks_auto_cluster_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSNetworkingPolicy"
}
resource "aws_iam_role_policy_attachment" "eks_auto_cluster_role_3" {
  role       = aws_iam_role.eks_auto_cluster_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSLoadBalancingPolicy"
}
resource "aws_iam_role_policy_attachment" "eks_auto_cluster_role_4" {
  role       = aws_iam_role.eks_auto_cluster_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSBlockStoragePolicy"
}
resource "aws_iam_role_policy_attachment" "eks_auto_node_role_0" {
  role       = aws_iam_role.eks_auto_node_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryPullOnly"
}
resource "aws_iam_role_policy_attachment" "eks_auto_node_role_1" {
  role       = aws_iam_role.eks_auto_node_role.name
...
kubectl patch svc kube-ops-view -p '{"metadata": {"annotations": {"service.beta.kubernetes.io/aws-load-balancer-nlb-target-type": "ip", "service.beta.kubernetes.io/aws-load-balancer-scheme":"internet-facing", "service.beta.kubernetes.io/aws-load-balancer-manage-backend-security-group-rules":"true", "service.beta.kubernetes.io/aws-load-balancer-security-groups":"${aws_security_group.nlb_service_security_group.id}"}}, "spec": {"type": "LoadBalancer", "loadBalancerClass": "eks.amazonaws.com/nlb"}}'
...
resource "aws_eks_addon" "core_dns_addon" {
  addon_name   = "coredns"
  cluster_name = aws_eks_cluster.eks_cluster.name
}
