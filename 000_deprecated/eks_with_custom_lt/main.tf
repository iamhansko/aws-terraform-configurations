# Generated from 000_deprecated/eks_with_custom_lt.yaml by tools/cfn2tf.
...
EOT
  ...
  depends_on                  = [aws_eks_cluster.eks_cluster, aws_ecr_repository.ecr]
}
