...
variable "aws_region" {
  type        = string
  default     = null
  description = "AWS region passed to 'aws eks update-kubeconfig'. Should be set together with eks_cluster_name."
}
...
variable "additional_user_data" {
  type        = string
  default     = ""
  description = "Additional shell script content merged in after the base bootstrap (code-server + optional Kubernetes tooling), appended to the base user_data script"
}
