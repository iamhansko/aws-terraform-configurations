# Generated from 007_eks_karpenter/eks_karpenter.yaml by tools/cfn2tf.
...
variable "eks_cluster_version" {
  ...
  default = 1.33
  validation {
    condition     = contains([1.33, 1.32, 1.31], var.eks_cluster_version)
    error_message = "EksClusterVersion must be one of: 1.33, 1.32, 1.31"
  }
}
