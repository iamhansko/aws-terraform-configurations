variable "cluster_name" {
  type        = string
  description = "Name of the EKS cluster to install the eks-pod-identity-agent addon into"
...
variable "addon_version" {
  type        = string
  default     = null
  description = "Specific eks-pod-identity-agent addon version (e.g. v1.3.8-eksbuild.2). When null, EKS picks the default version for the cluster's Kubernetes version"
