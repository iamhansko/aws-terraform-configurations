# Generated from 014_basic_ec2/bastion.yaml by tools/cfn2tf.
...
output "bastion_ec2_public_ip" {
  ...
  description = "GameAccessLink"
}
# CloudFormation output: Ec2InstanceList
output "ec2_instance_list" {
  value       = "https://${data.aws_region.current.region}.console.aws.amazon.com/ec2/home#Instances"
